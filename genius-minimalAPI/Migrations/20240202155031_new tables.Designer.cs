...
namespace geniusminimalAPI.Migrations
{
    ...
    [Migration("20240202155031_new tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("genius_minimalAPI.Domain.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("genius_minimalAPI.Domain.Entities.Popularity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("genius_minimalAPI.Domain.Entities.Popularity", b =>
                {
                    b.HasOne("genius_minimalAPI.Domain.Entities.Musician", "Musician")
                        .WithOne("Popularity")
                        .HasForeignKey("genius_minimalAPI.Domain.Entities.Popularity", "MusicianId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
